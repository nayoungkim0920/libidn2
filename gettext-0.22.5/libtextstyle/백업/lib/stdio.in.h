...
_GL_FUNCDECL_RPL (dprintf, int, (int fd, const char *restrict format, ...)
                                _GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_2_3
                                _GL_ARG_NONNULL ((2)));
...
_GL_FUNCDECL_RPL (fprintf, int,
                  (FILE *restrict fp, const char *restrict format, ...)
                  _GL_ATTRIBUTE_FORMAT_PRINTF_SYSTEM_2_3
                  _GL_ARG_NONNULL ((1, 2)));
#  endif
...
_GL_FUNCDECL_RPL (obstack_vprintf, int,
                  ...
                  _GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_2_0
                  _GL_ARG_NONNULL ((1, 2)));
...
_GL_FUNCDECL_RPL_1 (__printf__, int,
                    ...
                    _GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_1_2 
                    _GL_ARG_NONNULL ((1)));
#   else
_GL_FUNCDECL_RPL_1 (__printf__, int,
                    (const char *restrict format, ...)
                    __asm__ (@ASM_SYMBOL_PREFIX@
                             _GL_STDIO_MACROEXPAND_AND_STRINGIZE(rpl_printf))
                    _GL_ATTRIBUTE_FORMAT_PRINTF_SYSTEM_1_2
                    _GL_ARG_NONNULL ((1)));
#   endif
...
_GL_FUNCDECL_RPL (snprintf, int,
                  (char *restrict str, size_t size,
                   const char *restrict format, ...)
                  _GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_3_4
                  _GL_ARG_NONNULL ((3)));
...
_GL_FUNCDECL_RPL (vfprintf, int,
                  (FILE *restrict fp,
                   const char *restrict format, va_list args)
                  _GL_ATTRIBUTE_FORMAT_PRINTF_SYSTEM_2_0 
                  _GL_ARG_NONNULL ((1, 2)));
#  endif
...
_GL_FUNCDECL_RPL (vfscanf, int,
                  (FILE *restrict stream,
                   const char *restrict format, va_list args)
                  /*_GL_ATTRIBUTE_FORMAT_SCANF_SYSTEM (2, 0)*/ _GL_ATTRIBUTE_FORMAT_SCANF_SYSTEM_2_0 
                  _GL_ARG_NONNULL ((1, 2)));
...
_GL_FUNCDECL_RPL (vscanf, int, (const char *restrict format, va_list args)
                               /*_GL_ATTRIBUTE_FORMAT_SCANF_SYSTEM (1, 0)*/ _GL_ATTRIBUTE_FORMAT_SCANF_SYSTEM_1_0  
                               _GL_ARG_NONNULL ((1)));
