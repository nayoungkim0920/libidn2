...
#undef LIBTEXTSTYLE_BITSIZEOF_PTRDIFF_T

/* Define to the number of bits in type 'sig_atomic_t'. */
#undef LIBTEXTSTYLE_BITSIZEOF_SIG_ATOMIC_T

/* Define to the number of bits in type 'size_t'. */
#undef LIBTEXTSTYLE_BITSIZEOF_SIZE_T

/* Define to the number of bits in type 'wchar_t'. */
#undef LIBTEXTSTYLE_BITSIZEOF_WCHAR_T

/* Define to the number of bits in type 'wint_t'. */
#undef LIBTEXTSTYLE_BITSIZEOF_WINT_T

/* Define if we are cross compiling */
#undef LIBTEXTSTYLE_CROSS_COMPILING

/* Define to 1 if using 'alloca.c'. */
#undef LIBTEXTSTYLE_C_ALLOCA

/* Define to nothing for non-Windows platforms */
#undef LIBTEXTSTYLE_DLL_VARIABLE

/* Define to 1 if // is a file system root distinct from /. */
#undef LIBTEXTSTYLE_DOUBLE_SLASH_IS_DISTINCT_ROOT

/* Define this to 1 if F_DUPFD behavior does not match POSIX */
#undef LIBTEXTSTYLE_FCNTL_DUPFD_BUGGY

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module close shall be considered present. */
#undef LIBTEXTSTYLE_GNULIB_CLOSE

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module fscanf shall be considered present. */
#undef LIBTEXTSTYLE_GNULIB_FSCANF

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module fstat shall be considered present. */
#undef LIBTEXTSTYLE_GNULIB_FSTAT

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module msvc-nothrow shall be considered present. */
#undef LIBTEXTSTYLE_GNULIB_MSVC_NOTHROW

/* Define to 1 if printf and friends should be labeled with attribute
   "__gnu_printf__" instead of "__printf__" */
#undef LIBTEXTSTYLE_GNULIB_PRINTF_ATTRIBUTE_FLAVOR_GNU

/* Define if safe-write module is used */
#undef LIBTEXTSTYLE_GNULIB_SAFE_WRITE

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module scanf shall be considered present. */
#undef LIBTEXTSTYLE_GNULIB_SCANF

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module stat shall be considered present. */
#undef LIBTEXTSTYLE_GNULIB_STAT

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module strerror shall be considered present. */
#undef LIBTEXTSTYLE_GNULIB_STRERROR

/* Define to 1 when the gnulib module cloexec should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_CLOEXEC

/* Define to 1 when the gnulib module close should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_CLOSE

/* Define to 1 when the gnulib module dup2 should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_DUP2

/* Define to 1 when the gnulib module fcntl should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_FCNTL

/* Define to 1 when the gnulib module fgetc should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_FGETC

/* Define to 1 when the gnulib module fgets should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_FGETS

/* Define to 1 when the gnulib module fprintf should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_FPRINTF

/* Define to 1 when the gnulib module fputc should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_FPUTC

/* Define to 1 when the gnulib module fputs should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_FPUTS

/* Define to 1 when the gnulib module fread should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_FREAD

/* Define to 1 when the gnulib module fscanf should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_FSCANF

/* Define to 1 when the gnulib module fstat should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_FSTAT

/* Define to 1 when the gnulib module fwrite should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_FWRITE

/* Define to 1 when the gnulib module getc should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_GETC

/* Define to 1 when the gnulib module getchar should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_GETCHAR

/* Define to 1 when the gnulib module getdtablesize should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_GETDTABLESIZE

/* Define to 1 when the gnulib module getprogname should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_GETPROGNAME

/* Define to 1 when the gnulib module open should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_OPEN

/* Define to 1 when the gnulib module printf should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_PRINTF

/* Define to 1 when the gnulib module putc should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_PUTC

/* Define to 1 when the gnulib module putchar should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_PUTCHAR

/* Define to 1 when the gnulib module puts should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_PUTS

/* Define to 1 when the gnulib module scanf should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_SCANF

/* Define to 1 when the gnulib module stat should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_STAT

/* Define to 1 when the gnulib module strerror should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_STRERROR

/* Define to 1 when the gnulib module vfprintf should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_VFPRINTF

/* Define to 1 when the gnulib module vprintf should be tested. */
#undef LIBTEXTSTYLE_GNULIB_TEST_VPRINTF

/* Define if tputs module is used */
#undef LIBTEXTSTYLE_GNULIB_TPUTS

/* Define for gnulib xalloc */
#undef LIBTEXTSTYLE_GNULIB_XALLOC

/* Define if xalloc_die is available */
#undef LIBTEXTSTYLE_GNULIB_XALLOC_DIE

/* Define if xstrdup module is used */
#undef LIBTEXTSTYLE_GNULIB_XSTRDUP

/* Define to 1 if you have 'alloca' after including <alloca.h>, a header that
   may be supplied by this distribution. */
#undef LIBTEXTSTYLE_HAVE_ALLOCA

/* Define to 1 if <alloca.h> works. */
#undef LIBTEXTSTYLE_HAVE_ALLOCA_H

/* Define to 1 if you have the 'argz_add' function. */
#undef LIBTEXTSTYLE_HAVE_ARGZ_ADD

/* Define to 1 if you have the 'argz_append' function. */
#undef LIBTEXTSTYLE_HAVE_ARGZ_APPEND

/* Define to 1 if you have the 'argz_count' function. */
#undef LIBTEXTSTYLE_HAVE_ARGZ_COUNT

/* Define to 1 if you have the 'argz_create_sep' function. */
#undef LIBTEXTSTYLE_HAVE_ARGZ_CREATE_SEP

/* Define to 1 if you have the <argz.h> header file. */
#undef LIBTEXTSTYLE_HAVE_ARGZ_H

/* Define to 1 if you have the 'argz_insert' function. */
#undef LIBTEXTSTYLE_HAVE_ARGZ_INSERT

/* Define to 1 if you have the 'argz_next' function. */
#undef LIBTEXTSTYLE_HAVE_ARGZ_NEXT

/* Define to 1 if you have the 'argz_stringify' function. */
#undef LIBTEXTSTYLE_HAVE_ARGZ_STRINGIFY

/* Define if compiler does not support __attribute__((__malloc__)) */
#undef LIBTEXTSTYLE_HAVE_ATTRIBUTE_MALLOC

/* Define if compiler does not support __attribute__((nonnull)) */
#undef LIBTEXTSTYLE_HAVE_ATTRIBUTE_NONNULL

/* Define if compiler does not support __attribute__((__pure__)) */
#undef LIBTEXTSTYLE_HAVE_ATTRIBUTE_PURE

/* Define to 1 if C11 is supported. */
#undef LIBTEXTSTYLE_HAVE_C11

/* Define to 1 if you have the 'closedir' function. */
#undef LIBTEXTSTYLE_HAVE_CLOSEDIR

/* Define to 1 if C++17 is supported. */
#undef LIBTEXTSTYLE_HAVE_CPP17

/* Define to 1 if bool, true and false work as per C2023. */
#undef LIBTEXTSTYLE_HAVE_C_BOOL

/* Define to 1 if the static_assert keyword works. */
#undef LIBTEXTSTYLE_HAVE_C_STATIC_ASSERT

/* Define to 1 if C supports variable-length arrays. */
#undef LIBTEXTSTYLE_HAVE_C_VARARRAYS

/* Define to 1 if you have the declaration of 'cygwin_conv_path', and to 0 if
   you don't. */
#undef LIBTEXTSTYLE_HAVE_DECL_CYGWIN_CONV_PATH

/* Define to 1 if you have the declaration of 'ecvt', and to 0 if you don't.
   */
#undef LIBTEXTSTYLE_HAVE_DECL_ECVT

/* Define to 1 if you have the declaration of 'execvpe', and to 0 if you
   don't. */
#undef LIBTEXTSTYLE_HAVE_DECL_EXECVPE

/* Define to 1 if you have the declaration of 'fcloseall', and to 0 if you
   don't. */
#undef LIBTEXTSTYLE_HAVE_DECL_FCLOSEALL

/* Define to 1 if you have the declaration of 'fcvt', and to 0 if you don't.
   */
#undef LIBTEXTSTYLE_HAVE_DECL_FCVT

/* Define to 1 if you have the declaration of 'gcvt', and to 0 if you don't.
   */
#undef LIBTEXTSTYLE_HAVE_DECL_GCVT

/* Define to 1 if you have the declaration of 'getdtablesize', and to 0 if you
   don't. */
#undef LIBTEXTSTYLE_HAVE_DECL_GETDTABLESIZE

/* Define to 1 if you have the declaration of 'getw', and to 0 if you don't.
   */
#undef LIBTEXTSTYLE_HAVE_DECL_GETW

/* Define to 1 if you have the declaration of 'program_invocation_name', and
   to 0 if you don't. */
#undef LIBTEXTSTYLE_HAVE_DECL_PROGRAM_INVOCATION_NAME

/* Define to 1 if you have the declaration of 'program_invocation_short_name',
   and to 0 if you don't. */
#undef LIBTEXTSTYLE_HAVE_DECL_PROGRAM_INVOCATION_SHORT_NAME

/* Define to 1 if you have the declaration of 'putw', and to 0 if you don't.
   */
#undef LIBTEXTSTYLE_HAVE_DECL_PUTW

/* Define to 1 if you have the declaration of 'strerror_r', and to 0 if you
   don't. */
#undef LIBTEXTSTYLE_HAVE_DECL_STRERROR_R

/* Define to 1 if you have the declaration of '__argv', and to 0 if you don't.
   */
#undef LIBTEXTSTYLE_HAVE_DECL___ARGV

/* Define to 1 if you have the <dirent.h> header file. */
#undef LIBTEXTSTYLE_HAVE_DIRENT_H

/* Define if you have the GNU dld library. */
#undef LIBTEXTSTYLE_HAVE_DLD

/* Define to 1 if you have the <dld.h> header file. */
#undef LIBTEXTSTYLE_HAVE_DLD_H

/* Define to 1 if you have the 'dlerror' function. */
#undef LIBTEXTSTYLE_HAVE_DLERROR

/* Define to 1 if you have the <dlfcn.h> header file. */
#undef LIBTEXTSTYLE_HAVE_DLFCN_H

/* Define to 1 if you have the <dl.h> header file. */
#undef LIBTEXTSTYLE_HAVE_DL_H

/* Define if you have the _dyld_func_lookup function. */
#undef LIBTEXTSTYLE_HAVE_DYLD

/* Define to 1 if you have the `error' function. */
#undef LIBTEXTSTYLE_HAVE_ERROR

/* Define to 1 if you have the <error.h> header file. */
#undef LIBTEXTSTYLE_HAVE_ERROR_H

/* Define to 1 if the system has the type 'error_t'. */
#undef LIBTEXTSTYLE_HAVE_ERROR_T

/* Define to 1 if you have the 'fchdir' function. */
#undef LIBTEXTSTYLE_HAVE_FCHDIR

/* Define to 1 if you have the 'fcntl' function. */
#undef LIBTEXTSTYLE_HAVE_FCNTL

/* Define to 1 if using FlushFileBuffers on Windows. */
#undef LIBTEXTSTYLE_HAVE_FLUSH_FILE_BUFFERS

/* Define to 1 if you have the fsync' function. */
#undef LIBTEXTSTYLE_HAVE_FSYNC

/* Define to 1 if you have the 'getdtablesize' function. */
#undef LIBTEXTSTYLE_HAVE_GETDTABLESIZE

/* Define to 1 if you have the 'getexecname' function. */
#undef LIBTEXTSTYLE_HAVE_GETEXECNAME

/* Define to 1 if you have the `getprogname' function. */
#undef LIBTEXTSTYLE_HAVE_GETPROGNAME

/* Define to 1 if you have the <inttypes.h> header file. */
#undef LIBTEXTSTYLE_HAVE_INTTYPES_H

/* Define if you have <langinfo.h> and nl_langinfo(CODESET). */
#undef LIBTEXTSTYLE_HAVE_LANGINFO_CODESET

/* Define if you have the libdl library or equivalent. */
#undef LIBTEXTSTYLE_HAVE_LIBDL

/* Define if libdlloader will be built on this platform */
#undef LIBTEXTSTYLE_HAVE_LIBDLLOADER

/* Define to 1 if you have the <lib/xgetaname-impl.h> header file. */
#undef LIBTEXTSTYLE_HAVE_LIB_XGETANAME_IMPL_H

/* Define to 1 if you have the <lib/xgethostname.h> header file. */
#undef LIBTEXTSTYLE_HAVE_LIB_XGETHOSTNAME_H

/* Define to 1 if you have the <limits.h> header file. */
#undef LIBTEXTSTYLE_HAVE_LIMITS_H

/* Define to 1 if the system has the type 'long long int'. */
#undef LIBTEXTSTYLE_HAVE_LONG_LONG_INT

/* Define to 1 if you have the 'lstat' function. */
#undef LIBTEXTSTYLE_HAVE_LSTAT

/* Define this if a modern libltdl is already installed */
#undef LIBTEXTSTYLE_HAVE_LTDL

/* Define to 1 if you have the <mach-o/dyld.h> header file. */
#undef LIBTEXTSTYLE_HAVE_MACH_O_DYLD_H

/* Define to 1 if you have the 'malloc' function. */
#undef LIBTEXTSTYLE_HAVE_MALLOC

/* Define to 1 if you have the <minix/config.h> header file. */
#undef LIBTEXTSTYLE_HAVE_MINIX_CONFIG_H

/* Define to 1 on MSVC platforms that have the "invalid parameter handler"
   concept. */
#undef LIBTEXTSTYLE_HAVE_MSVC_INVALID_PARAMETER_HANDLER

/* Define to 1 if you have the 'opendir' function. */
#undef LIBTEXTSTYLE_HAVE_OPENDIR

/* Define if libtool can extract symbol lists from object files. */
#undef LIBTEXTSTYLE_HAVE_PRELOADED_SYMBOLS

/* Define to 1 if you have the 'printf' function. */
#undef LIBTEXTSTYLE_HAVE_PRINTF

/* Define to 1 if you have the 'readdir' function. */
#undef LIBTEXTSTYLE_HAVE_READDIR

/* Define to 1 if you have the 'rpl_stpcpy' function. */
#undef LIBTEXTSTYLE_HAVE_RPL_STPCPY

/* Define to 1 if you have the <sdkddkver.h> header file. */
#undef LIBTEXTSTYLE_HAVE_SDKDDKVER_H

/* Define to 1 if you have the 'setdtablesize' function. */
#undef LIBTEXTSTYLE_HAVE_SETDTABLESIZE

/* Define if you have the shl_load function. */
#undef LIBTEXTSTYLE_HAVE_SHL_LOAD

/* Define to 1 if 'sig_atomic_t' is a signed integer type. */
#undef LIBTEXTSTYLE_HAVE_SIGNED_SIG_ATOMIC_T

/* Define to 1 if 'wchar_t' is a signed integer type. */
#undef LIBTEXTSTYLE_HAVE_SIGNED_WCHAR_T

/* Define to 1 if 'wint_t' is a signed integer type. */
#undef LIBTEXTSTYLE_HAVE_SIGNED_WINT_T

/* Define to 1 if you have the <stdbool.h> header file. */
#undef LIBTEXTSTYLE_HAVE_STDBOOL_H

/* Define to 1 if you have the <stdckdint.h> header file. */
#undef LIBTEXTSTYLE_HAVE_STDCKDINT_H

/* Define to 1 if you have the <stdint.h> header file. */
#undef LIBTEXTSTYLE_HAVE_STDINT_H

/* Define to 1 if you have the <stdio.h> header file. */
#undef LIBTEXTSTYLE_HAVE_STDIO_H

/* Define to 1 if you have the <stdlib.h> header file. */
#undef LIBTEXTSTYLE_HAVE_STDLIB_H

/* Define to 1 if you have the `strerror_r' function. */
#undef LIBTEXTSTYLE_HAVE_STRERROR_R

/* Define to 1 if you have the <strings.h> header file. */
#undef LIBTEXTSTYLE_HAVE_STRINGS_H

/* Define to 1 if you have the <string.h> header file. */
#undef LIBTEXTSTYLE_HAVE_STRING_H

/* Define to 1 if you have the 'strlcat' function. */
#undef LIBTEXTSTYLE_HAVE_STRLCAT

/* Define to 1 if you have the 'strlcpy' function. */
#undef LIBTEXTSTYLE_HAVE_STRLCPY

/* Define to 1 if 'st_atimensec' is a member of 'struct stat'. */
#undef LIBTEXTSTYLE_HAVE_STRUCT_STAT_ST_ATIMENSEC

/* Define to 1 if 'st_atimespec.tv_nsec' is a member of 'struct stat'. */
#undef LIBTEXTSTYLE_HAVE_STRUCT_STAT_ST_ATIMESPEC_TV_NSEC

/* Define to 1 if 'st_atim.st__tim.tv_nsec' is a member of 'struct stat'. */
#undef LIBTEXTSTYLE_HAVE_STRUCT_STAT_ST_ATIM_ST__TIM_TV_NSEC

/* Define to 1 if 'st_atim.tv_nsec' is a member of 'struct stat'. */
#undef LIBTEXTSTYLE_HAVE_STRUCT_STAT_ST_ATIM_TV_NSEC

/* Define to 1 if 'st_birthtimensec' is a member of 'struct stat'. */
#undef LIBTEXTSTYLE_HAVE_STRUCT_STAT_ST_BIRTHTIMENSEC

/* Define to 1 if 'st_birthtimespec.tv_nsec' is a member of 'struct stat'. */
#undef LIBTEXTSTYLE_HAVE_STRUCT_STAT_ST_BIRTHTIMESPEC_TV_NSEC

/* Define to 1 if 'st_birthtim.tv_nsec' is a member of 'struct stat'. */
#undef LIBTEXTSTYLE_HAVE_STRUCT_STAT_ST_BIRTHTIM_TV_NSEC

/* Define to 1 if you have the 'symlink' function. */
#undef LIBTEXTSTYLE_HAVE_SYMLINK

/* Define to 1 if you have the <sys/bitypes.h> header file. */
#undef LIBTEXTSTYLE_HAVE_SYS_BITYPES_H

/* Define to 1 if you have the <sys/dl.h> header file. */
#undef LIBTEXTSTYLE_HAVE_SYS_DL_H

/* Define to 1 if you have the <sys/inttypes.h> header file. */
#undef LIBTEXTSTYLE_HAVE_SYS_INTTYPES_H

/* Define to 1 if you have the <sys/param.h> header file. */
#undef LIBTEXTSTYLE_HAVE_SYS_PARAM_H

/* Define to 1 if you have the <sys/socket.h> header file. */
#undef LIBTEXTSTYLE_HAVE_SYS_SOCKET_H

/* Define to 1 if you have the <sys/stat.h> header file. */
#undef LIBTEXTSTYLE_HAVE_SYS_STAT_H

/* Define to 1 if you have the <sys/time.h> header file. */
#undef LIBTEXTSTYLE_HAVE_SYS_TIME_H

/* Define to 1 if you have the <sys/types.h> header file. */
#undef LIBTEXTSTYLE_HAVE_SYS_TYPES_H

/* Define to 1 if you have the <textstyle/woe32dll.h> header file. */
#undef LIBTEXTSTYLE_HAVE_TEXTSTYLE_WOE32DLL_H

/* Define to 1 if you have the <unistd.h> header file. */
#undef LIBTEXTSTYLE_HAVE_UNISTD_H

/* Define to 1 if the system has the type 'unsigned long long int'. */
#undef LIBTEXTSTYLE_HAVE_UNSIGNED_LONG_LONG_INT

/* Define if you have a global __progname variable */
#undef LIBTEXTSTYLE_HAVE_VAR___PROGNAME

/* Define to 1 if you have the <wchar.h> header file. */
#undef LIBTEXTSTYLE_HAVE_WCHAR_H

/* Define to 1 if you have Windows consoles. */
#undef LIBTEXTSTYLE_HAVE_WINDOWS_CONSOLES

/* Define to 1 if you have the <winsock2.h> header file. */
#undef LIBTEXTSTYLE_HAVE_WINSOCK2_H

/* Define if you have the 'wint_t' type. */
#undef LIBTEXTSTYLE_HAVE_WINT_T

/* This value is set to 1 to indicate that the system argz facility works */
#undef LIBTEXTSTYLE_HAVE_WORKING_ARGZ

/* Define to 1 if O_NOATIME works. */
#undef LIBTEXTSTYLE_HAVE_WORKING_O_NOATIME

/* Define to 1 if O_NOFOLLOW works. */
#undef LIBTEXTSTYLE_HAVE_WORKING_O_NOFOLLOW

/* Define to 1 if you have the 'xalloc_die' function. */
#undef LIBTEXTSTYLE_HAVE_XALLOC_DIE

/* Define to 1 if you have the <xalloc.h> header file. */
#undef LIBTEXTSTYLE_HAVE_XALLOC_H

/* Define to 1 if you have the 'xmalloc' function. */
#undef LIBTEXTSTYLE_HAVE_XMALLOC

/* Define to 1 if you have the 'xrealloc' function. */
#undef LIBTEXTSTYLE_HAVE_XREALLOC

/* Define to 1 if you have the '_get_osfhandle' function. */
#undef LIBTEXTSTYLE_HAVE__GET_OSFHANDLE

/* Define to 1 if you have the '_set_invalid_parameter_handler' function. */
#undef LIBTEXTSTYLE_HAVE__SET_INVALID_PARAMETER_HANDLER

/* Define to 1 if ctype.h defines __header_inline. */
#undef LIBTEXTSTYLE_HAVE___HEADER_INLINE
...
#undef LIBTEXTSTYLE_HAVE___XPG_STRERROR_R

/* Define if the OS needs help to load dependent libraries for dlopen(). */
#undef LIBTEXTSTYLE_LTDL_DLOPEN_DEPLIBS

/* Define to the system default library search path. */
#undef LIBTEXTSTYLE_LT_DLSEARCH_PATH

/* The archive extension */
#undef LIBTEXTSTYLE_LT_LIBEXT

/* The archive prefix */
#undef LIBTEXTSTYLE_LT_LIBPREFIX

/* Define to the extension used for runtime loadable modules, say, ".so". */
#undef LIBTEXTSTYLE_LT_MODULE_EXT

/* Define to the name of the environment variable that determines the run-time
   module search path. */
#undef LIBTEXTSTYLE_LT_MODULE_PATH_VAR

/* Define to the sub-directory where libtool stores uninstalled libraries. */
#undef LIBTEXTSTYLE_LT_OBJDIR

/* Define to the shared library suffix, say, ".dylib". */
#undef LIBTEXTSTYLE_LT_SHARED_EXT

/* Define to the shared archive member specification, say "(shr.o)". */
#undef LIBTEXTSTYLE_LT_SHARED_LIB_MEMBER

/* If malloc(0) is != NULL, define this to 1. Otherwise define this to 0. */
#undef LIBTEXTSTYLE_MALLOC_0_IS_NONNULL
...
#undef LIBTEXTSTYLE_MUSL_LIBC

/* Define if dlsym() requires a leading underscore in symbol names. */
#undef LIBTEXTSTYLE_NEED_USCORE

/* Define to 1 if open() fails to recognize a trailing slash. */
#undef LIBTEXTSTYLE_OPEN_TRAILING_SLASH_BUG

/* Name of package */
#undef LIBTEXTSTYLE_PACKAGE

/* Define to the address where bug reports for this package should be sent. */
#undef LIBTEXTSTYLE_PACKAGE_BUGREPORT

/* Define to the full name of this package. */
#undef LIBTEXTSTYLE_PACKAGE_NAME

/* Define to the full name and version of this package. */
#undef LIBTEXTSTYLE_PACKAGE_STRING

/* Define to the one symbol short name of this package. */
#undef LIBTEXTSTYLE_PACKAGE_TARNAME

/* Define to the home page for this package. */
#undef LIBTEXTSTYLE_PACKAGE_URL

/* Define to the version of this package. */
#undef LIBTEXTSTYLE_PACKAGE_VERSION

/* Define to the type that is the result of default argument promotions of
   type mode_t. */
#undef LIBTEXTSTYLE_PROMOTED_MODE_T

/* Define to l, ll, u, ul, ull, etc., as suitable for constants of type
   'ptrdiff_t'. */
#undef LIBTEXTSTYLE_PTRDIFF_T_SUFFIX

/* Define to 1 if stat needs help when passed a file name with a trailing
   slash */
#undef LIBTEXTSTYLE_REPLACE_FUNC_STAT_FILE

/* Define to 1 if strerror(0) does not return a message implying success. */
#undef LIBTEXTSTYLE_REPLACE_STRERROR_0

/* Define to l, ll, u, ul, ull, etc., as suitable for constants of type
   'sig_atomic_t'. */
#undef LIBTEXTSTYLE_SIG_ATOMIC_T_SUFFIX

/* Define to l, ll, u, ul, ull, etc., as suitable for constants of type
   'size_t'. */
#undef LIBTEXTSTYLE_SIZE_T_SUFFIX
...
#undef LIBTEXTSTYLE_STACK_DIRECTION

/* Define to 1 if the 'S_IS*' macros in <sys/stat.h> do not work properly. */
#undef LIBTEXTSTYLE_STAT_MACROS_BROKEN

/* Define to 1 if all of the C89 standard headers exist (not just the ones
   required in a freestanding environment). This macro is provided for
   backward compatibility; new code need not use it. */
#undef LIBTEXTSTYLE_STDC_HEADERS

/* Define to 1 if strerror_r returns char *. */
#undef LIBTEXTSTYLE_STRERROR_R_CHAR_P

/* Define to 1 if the type of the st_atim member of a struct stat is struct
   timespec. */
#undef LIBTEXTSTYLE_TYPEOF_STRUCT_STAT_ST_ATIM_IS_STRUCT_TIMESPEC
...
#undef LIBTEXTSTYLE_VERSION

/* Define to l, ll, u, ul, ull, etc., as suitable for constants of type
   'wchar_t'. */
#undef LIBTEXTSTYLE_WCHAR_T_SUFFIX

/* Define to l, ll, u, ul, ull, etc., as suitable for constants of type
   'wint_t'. */
#undef LIBTEXTSTYLE_WINT_T_SUFFIX

/* Number of bits in a file offset, on hosts where this is settable. */
#undef LIBTEXTSTYLE__FILE_OFFSET_BITS

/* Define as empty if __attribute__((nonnull(1))) is not supported */
#undef LIBTEXTSTYLE__GL_ARG_NONNULL_1

/* Define as empty if __attribute__((nonnull(1,2))) is not supported */
#undef LIBTEXTSTYLE__GL_ARG_NONNULL_1_2

/* Define as empty if __attribute__((nonnull(1,3))) is not supported */
#undef LIBTEXTSTYLE__GL_ARG_NONNULL_1_3

/* Define as empty if __attribute__((nonnull(3))) is not supported */
#undef LIBTEXTSTYLE__GL_ARG_NONNULL_3

/* Define to enable async safe functions */
#undef LIBTEXTSTYLE__GL_ASYNC_SAFE

/* Define to __attribute__((cold)) */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_COLD

/* Define as empty if __attribute__((__malloc__ (f, i))) is not supported */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_DEALLOC

/* Define to _GL_ATTRIBUTE_SPEC_PRINTF_ERROR */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_FORMAT

/* Define for format attribute with index 5, 6 */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_FORMAT_ERROR_AT_LINE

/* Define to use printf format attribute with parameters (1, 2) */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_1_2

/* Define to use printf format attribute with parameters (2, 0) */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_2_0

/* Define to use printf format attribute with parameters (2, 3) */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_2_3

/* Define to use printf format attribute with parameters (3, 0) */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_3_0

/* Define to use printf format attribute with parameters (3, 4) */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_3_4

/* Define to use printf format attribute with parameters (1, 0) */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_FORMAT_PRINTF_SYSTEM_1_0

/* Define to use printf format attribute with parameters (2, 3) */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_FORMAT_PRINTF_SYSTEM_2_3

/* Define as empty if __attribute__((__malloc__)) is not supported */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_MALLOC

/* Define to __attribute__((unused)) */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_MAYBE_UNUSED

/* Define for attribute noreturn */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_NORETURN

/* Define as empty if __attribute__((__pure__)) is not supported */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_PURE

/* Define to __attribute__((format(printf, 3, 4))) */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_SPEC_PRINTF_ERROR

/* Define for format attribute with index 3, 0 */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_SPEC_PRINTF_STANDARD_ERROR

/* Define for format attribute with index 5, 0 */
#undef LIBTEXTSTYLE__GL_ATTRIBUTE_SPEC_PRINTF_STANDARD_ERROR_AT_LINE

/* Define to prevent multiple inclusion */
#undef LIBTEXTSTYLE__GL_CONFIG_H_INCLUDED
...
/* Define if compiler does not support __attribute__((__alloc_size__)) */
#undef LIBTEXTSTYLE__GL_HAS_ATTRIBUTE_ALLOC_SIZE

/* Define if compiler does not support __attribute__((returns_nonnull)) */
#undef LIBTEXTSTYLE__GL_HAS_ATTRIBUTE_RETURNS_NONNULL

/* Define for inline */
#undef LIBTEXTSTYLE__GL_INLINE

/* Define for inline header start */
#undef LIBTEXTSTYLE__GL_INLINE_HEADER_BEGIN

/* Define for inline header end */
#undef LIBTEXTSTYLE__GL_INLINE_HEADER_END

/* Define for list inline */
#undef LIBTEXTSTYLE__GL_LIST_INLINE

/* Define if _get_osfhandle is not available */
#undef LIBTEXTSTYLE__GL_NOTHROW_GET_OSFHANDLE

/* Define to enable the declarations of ISO C 11 types and functions. */
#undef LIBTEXTSTYLE__ISOC11_SOURCE

/* Define to 1 on platforms where this makes off_t a 64-bit type. */
#undef LIBTEXTSTYLE__LARGE_FILES

/* Define so that AIX headers are more compatible with GNU/Linux. */
#undef LIBTEXTSTYLE__LINUX_SOURCE_COMPAT
...
#undef LIBTEXTSTYLE__TIME_BITS

/* For standard stat data types on VMS. */
#undef LIBTEXTSTYLE__USE_STD_STAT

/* Define to 1 on platforms where this makes time_t a 64-bit type. */
#undef LIBTEXTSTYLE___MINGW_USE_VC2005_COMPAT

/* Define to 1 if the system <stdint.h> predates C++11. */
#undef LIBTEXTSTYLE___STDC_CONSTANT_MACROS

/* Define to 1 if the system <stdint.h> predates C++11. */
#undef LIBTEXTSTYLE___STDC_LIMIT_MACROS

/* Define to 1 if C does not support variable-length arrays, and if the
   compiler does not already define this. */
#undef LIBTEXTSTYLE___STDC_NO_VLA__

/* Define so that glibc/gnulib argp.h does not typedef error_t. */
#undef LIBTEXTSTYLE___error_t_defined
...
#undef _libtextstyle_mode_t

/* Define to the type of st_nlink in struct stat, or a supertype. */
#undef _libtextstyle_nlink_t

/* Define as a signed integer type capable of holding a process identifier. */
#undef _libtextstyle_pid_t

/* Define to the equivalent of the C99 'restrict' keyword, or to
   nothing if this is not supported.  Do not define if restrict is
   supported only directly.  */
#undef _libtextstyle_restrict
...
#undef _libtextstyle_size_t

/* Define as a signed type of the same size as size_t. */
#undef _libtextstyle_ssize_t
