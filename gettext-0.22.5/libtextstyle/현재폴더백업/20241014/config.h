/* \libidn2\gettext-0.22.5\libtextstyle\config.h.  Generated from configure.ac by autoheader.  */
...
#undef HAVE_LIB_XGETANAME_IMPL_H

/* Define to 1 if you have the <lib/xgethostname.h> header file. */
#undef HAVE_LIB_XGETHOSTNAME_H
...
#undef HAVE_TEXTSTYLE_WOE32DLL_H
...
#undef _GL_ATTRIBUTE_SPEC_PRINTF_ERROR

/* Define for format attribute with index 3, 0 */
#undef _GL_ATTRIBUTE_SPEC_PRINTF_STANDARD_ERROR

/* Define for format attribute with index 5, 0 */
#undef _GL_ATTRIBUTE_SPEC_PRINTF_STANDARD_ERROR_AT_LINE
...
#undef _GL_HAS_ATTRIBUTE_ALLOC_SIZE

/* Define if compiler does not support __attribute__((returns_nonnull)) */
#undef _GL_HAS_ATTRIBUTE_RETURNS_NONNULL
...
#undef _GL_LIST_INLINE

/* Define if _get_osfhandle is not available */
#undef _GL_NOTHROW_GET_OSFHANDLE
