...
#  if !(defined __cplusplus && defined GNULIB_NAMESPACE)
#   undef getprogname
#   define getprogname rpl_getprogname /*getprogname 함수가 실제로 rpl_getprogname으로 대체된다는 것을 의미, rpl_getprogname은 GNULIB의 대체 구현으로, GNULIB 모듈이 필요*/
#  endif
#  if 0
