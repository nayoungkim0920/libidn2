...
/*nodiscard warning 추가*/
//_GL_ATTRIBUTE_NODISCARD int gl_list_node_nx_set_value(gl_list_t list, gl_list_node_t node, const void *elt);
//_GL_ATTRIBUTE_NODISCARD gl_list_node_t gl_list_nx_set_at(gl_list_t list, size_t position, const void *elt);
