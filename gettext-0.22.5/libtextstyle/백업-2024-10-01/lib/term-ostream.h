...
#include "ostream.h" // Includes the definition for ostream_t
#include "term_ostream.priv.h" // Includes term_ostream_representation and any_ostream_representation
#include "error.h"
