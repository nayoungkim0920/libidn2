...
typedef ostream_t term_file_ostream_t; //term_ostream_t -> term_file_ostream_t로 변경
...
//typedef int term_color_t; //term_ostream.priv.h로 이동
...
/* term_file_ostream_t is a subtype of ostream_t.  */
//typedef ostream_t term_file_ostream_t;

/* Functions that invoke the methods.  */
#ifdef __cplusplus
extern "C" {
#endif
extern void term_ostream_write_mem (term_file_ostream_t first_arg, const void *data, size_t len);
extern void term_ostream_flush (term_file_ostream_t first_arg, ostream_flush_scope_t scope);
extern void term_ostream_free (term_file_ostream_t first_arg);
extern term_color_t term_ostream_rgb_to_color (term_file_ostream_t first_arg, int red, int green, int blue);
extern term_color_t term_ostream_get_color (term_file_ostream_t first_arg);
extern void term_ostream_set_color (term_file_ostream_t first_arg, term_color_t color);
extern term_color_t term_ostream_get_bgcolor (term_file_ostream_t first_arg);
extern void term_ostream_set_bgcolor (term_file_ostream_t first_arg, term_color_t color);
extern term_weight_t term_ostream_get_weight (term_file_ostream_t first_arg);
extern void term_ostream_set_weight (term_file_ostream_t first_arg, term_weight_t weight);
extern term_posture_t term_ostream_get_posture (term_file_ostream_t first_arg);
extern void term_ostream_set_posture (term_file_ostream_t first_arg, term_posture_t posture);
extern term_underline_t term_ostream_get_underline (term_file_ostream_t first_arg);
extern void term_ostream_set_underline (term_file_ostream_t first_arg, term_underline_t underline);
extern const char *term_ostream_get_hyperlink_ref (term_file_ostream_t first_arg);
extern const char *term_ostream_get_hyperlink_id (term_file_ostream_t first_arg);
extern void term_ostream_set_hyperlink (term_file_ostream_t first_arg, const char *ref, const char *id);
...
extern void term_ostream_flush_to_current_style (term_file_ostream_t first_arg);
/* Accessors.  */
extern int term_ostream_get_descriptor (term_file_ostream_t stream);
extern const char *term_ostream_get_filename (term_file_ostream_t stream);
extern ttyctl_t term_ostream_get_tty_control (term_file_ostream_t stream);
extern ttyctl_t term_ostream_get_effective_tty_control (term_file_ostream_t stream);
#ifdef __cplusplus
}
#endif
...
/* Accessors.  */
extern term_file_ostream_t term_styled_ostream_get_destination (term_styled_ostream_t stream);
