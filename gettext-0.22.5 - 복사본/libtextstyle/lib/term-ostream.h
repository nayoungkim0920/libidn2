...
// redeclaration by lib/textstyle.h => term_ostream.priv.h 이동
//enum
//{
...
public:
    ...
    operator ostream_t () { return (term_ostream_t) (struct any_ostream_representation *) _pointer; }
    explicit term_ostream_t (term_ostream_t x) : _pointer ((struct term_ostream_representation *) (void *) x) {}
...
extern bool is_instance_of_term_ostream (term_ostream_t stream)
