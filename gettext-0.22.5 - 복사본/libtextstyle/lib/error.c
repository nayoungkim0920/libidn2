...
/*#    error "this configure-time declaration test was not run"*/ /*수정*/
#  endif
...
static void _GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_3_0 _GL_ARG_NONNULL_3
                  ...
                  va_list args, unsigned int mode_flags)
{
  ...
  if (error_print_progname)
    ...
    {
		/* 추가 */
		/* 중복선언으로 # define program_name program_invocation_name*/
