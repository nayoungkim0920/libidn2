...
#define HAVE_TEXTSTYLE_WOE32DLL_H 1
...
#define PACKAGE_BUGREPORT "bug-libtextstyle@example.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "libtextstyle"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "libtextstyle 0.1"
...
#define _GL_ATTRIBUTE_FORMAT_ERROR_AT_LINE __attribute__((format(printf, 5, 6)))

/* Define to use printf format attribute with parameters (1, 2) */
#define _GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_1_2 __attribute__((format(printf, 1, 2)))

/* Define to use printf format attribute with parameters (2, 0) */
#define _GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_2_0 __attribute__((format(printf, 2, 0)))

/* Define to use printf format attribute with parameters (2, 3) */
#define _GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_2_3 __attribute__((format(printf, 2, 3)))

/* Define to use printf format attribute with parameters (3, 0) */
#define _GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_3_0 __attribute__((format(printf, 3, 0)))

/* Define to use printf format attribute with parameters (3, 4) */
#define _GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD_3_4 __attribute__((format(printf, 3, 4)))

/* Define to use printf format attribute with parameters (1, 0) */
#define _GL_ATTRIBUTE_FORMAT_PRINTF_SYSTEM_1_0 __attribute__((format(printf, 1, 0)))

/* Define to use printf format attribute with parameters (2, 3) */
#define _GL_ATTRIBUTE_FORMAT_PRINTF_SYSTEM_2_3 __attribute__((format(printf, 2, 3)))
...
#define _GL_ATTRIBUTE_NORETURN __attribute__((noreturn))

/* Define as empty if __attribute__((__pure__)) is not supported */
#define _GL_ATTRIBUTE_PURE /**/

/* Define to __attribute__((format(printf, 3, 4))) */
#define _GL_ATTRIBUTE_SPEC_PRINTF_ERROR __attribute__((format(printf, 3, 4)))

/* Define for format attribute with index 3, 0 */
#define _GL_ATTRIBUTE_SPEC_PRINTF_STANDARD_ERROR __attribute__((format(printf, 3, 0)))

/* Define for format attribute with index 5, 0 */
#define _GL_ATTRIBUTE_SPEC_PRINTF_STANDARD_ERROR_AT_LINE __attribute__((format(printf, 5, 0)))
...
#define _GL_HAS_ATTRIBUTE_ALLOC_SIZE 0

/* Define if compiler does not support __attribute__((returns_nonnull)) */
#define _GL_HAS_ATTRIBUTE_RETURNS_NONNULL 1
